...
<body>
  ...
  <ul class="list-group">
      ...
      <a href="addschools.php"><li class="list-group-item">Manage School</li></a>
...
?>
          ...
          <thead>
            <tr>
              <th>School Id</th><th>School Name</th><th>Address</th><th>Amount</th><th>Edit</th>
            </tr>
          </thead>
    ...
    echo('<a href="editschools.php?school_id='.$row['school_id'].'"> <b> Edit </b> </a>');
    echo("</td><td>");
